...
-- Trial abuse tracking + referrals (run after main schema sync)
DO $$ BEGIN ALTER TABLE "Company" ADD COLUMN "referralAccessUntil" TIMESTAMP(3);
EXCEPTION WHEN duplicate_column THEN NULL; END $$;

DO $$ BEGIN ALTER TABLE "User" ADD COLUMN "firstName" TEXT;
EXCEPTION WHEN duplicate_column THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE "User" ADD COLUMN "lastName" TEXT;
EXCEPTION WHEN duplicate_column THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE "User" ADD COLUMN "referralCode" TEXT;
EXCEPTION WHEN duplicate_column THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE "User" ADD COLUMN "referredByUserId" TEXT;
EXCEPTION WHEN duplicate_column THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE "User" ADD COLUMN "pendingReferralCode" TEXT;
EXCEPTION WHEN duplicate_column THEN NULL; END $$;
...
DO $$ BEGIN ALTER TABLE "User" ADD CONSTRAINT "User_referredByUserId_fkey"
...
DO $$ BEGIN ALTER TABLE "ReferralReward" ADD CONSTRAINT "ReferralReward_referrerId_fkey"
  FOREIGN KEY ("referrerId") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;
EXCEPTION WHEN duplicate_object THEN NULL; END $$;
DO $$ BEGIN ALTER TABLE "ReferralReward" ADD CONSTRAINT "ReferralReward_refereeId_fkey"
